...
router.post('/Domestic/SendoutCancel', (req, res) => {

  const _logger = logger('Domestic [SENDOUT CANCEL]')
  ...
  try {
    ...
    const query = `CALL kpdomestic.DomesticSOCancelAgent('${kptn}','${transdate}','${bcode}','${zcode}','${employee}')`;
