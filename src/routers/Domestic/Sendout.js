...
router.post('/Domestic/Sendout', (req, res) => {

  const _logger = logger('Domestic [SENDOUT]')
  ...
  try {
    ...
    const query = `CALL kpdomestic.DomesticSOAgent('${kptn}','${transdate}','${bcode}','${zcode}','${employee}')`;
