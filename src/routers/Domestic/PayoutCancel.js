...
router.post('/Domestic/PayoutCancel', (req, res) => {

  const _logger = logger('Domestic [PAYOUT CANCEL]');
  ...
  try {
    ...
    const query = `CALL kpdomestic.DomesticPOCancelAgent('${kptn}','${transdate}','${bcode}','${zcode}','${employee}')`;
