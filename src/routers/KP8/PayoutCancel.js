...
router.post('/KP8/PayoutCancel', (req, res) => {

  const _logger = logger('KP8 [PAYOUT CANCEL]');
  ...
  try {
    ...
    const query = `CALL kptransactions.KP8POCancelAgent(''${kptn}'','${transdate}','${bcode}','${zcode}','${employee}')`;
