...
router.post('/KP8/SendoutCancel', (req, res) => {

  const _logger = logger('KP8 [SENDOUT CANCEL]')
  ...
  try {
    ...
    const query = `CALL kptransactions.KP8SOCancelAgent(''${kptn}'','${transdate}','${bcode}','${zcode}','${employee}')`;
