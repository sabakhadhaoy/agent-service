...
router.post('/Global/PayoutCancel', (req, res) => {

  const _logger = logger('Global [PAYOUT CANCEL]');
  ...
  try {
    ...
    const query = `CALL kpglobal.GlobalPOCancelAgent(''${kptn}'','${transdate}','${bcode}','${zcode}','${employee}')`;
