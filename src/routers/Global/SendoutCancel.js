...
router.post('/Global/SendoutCancel', (req, res) => {

  const _logger = logger('Global [SENDOUT CANCEL]')
  ...
  try {
    ...
    const query = `CALL kpglobal.GlobalSOCancelAgent(''${kptn}'','${transdate}','${bcode}','${zcode}','${employee}')`;
