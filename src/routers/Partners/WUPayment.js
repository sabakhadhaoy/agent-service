...
router.post('/Partners/WUPayment', (req, res) => {
  ...
  try {
    ...
    const wuPayment_query = `CALL kpbillspayment.BillspaymentWUPaymentAgent(''${kptn}'','${transdate}','${bcode}','${zcode}','${employee}')`;
