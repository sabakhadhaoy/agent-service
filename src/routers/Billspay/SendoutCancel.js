...
router.post('/Billspay/SendoutCancel', (req, res) => {

  const _logger = logger('Billspay [SENDOUT CANCEL]');
  ...
  try {
    ...
    const query = `CALL kpbillspayment.BillspaySOCancelAgent(''${kptn}'','${transdate}','${bcode}','${zcode}','${employee}')`;
